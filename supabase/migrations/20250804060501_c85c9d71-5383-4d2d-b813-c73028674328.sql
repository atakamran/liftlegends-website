-- Insert coaches and gyms without conflict handling
-- First clear any existing data if needed
TRUNCATE public.coaches RESTART IDENTITY CASCADE;

-- Insert coaches with explicit ID generation
INSERT INTO public.coaches (id, full_name, bio, expertise, experience_years) VALUES
(gen_random_uuid(), 'احمد محمدی', 'مربی پرورش اندام با ۱۰ سال تجربه در زمینه بدنسازی و تناسب اندام', 'پرورش اندام، کاهش وزن، تناسب اندام', 10),
